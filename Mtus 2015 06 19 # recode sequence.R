...
# Mean Paid Work during Week End 
...
recodes = 
  list( 'a Sleep' = c("Sleep"), 
        ...
        'c Work' = c(  "Activities related to job seeking", 
...
# The final database is -----> dtc 
# The sequences are -----> dtcseq_r 

# save(dtc, file = '/Users/giacomovagni/Documents/Data/TimeUse/UK/DataUKarticle/dtc.RData')
# save(dtcseq_r, file = '/Users/giacomovagni/Documents/Data/TimeUse/UK/DataUKarticle/dtcseq_r.RData')
